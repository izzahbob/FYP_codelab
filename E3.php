...
<body>
    ...
    <div class="exercise-container">
        <h2>Multiply Two Numbers : Without * Operator</h2>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Create a method that multiplies two integers without using the <code>*</code> operator.</li>
                <li>Use a loop to add one number repeatedly, based on the value of the other number.</li>
                <li>Handle negative numbers by checking the sign.</li>
            </ol>
        </div>
