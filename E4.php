...
<body>
    ...
    <div class="exercise-container">
        <h2>Array : Find The Missing Number</h2>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Given an array containing numbers from 1 to N with one number missing, write a program to find the missing number.</li>
                <li>Use the formula for the sum of first N natural numbers and subtract the sum of the array.</li>
            </ol>
        </div>
