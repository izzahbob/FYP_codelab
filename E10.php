...
<body>
    ...
    <div class="exercise-container">
        <h2>Calculation : Find Prime Number in a Range</h2>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Write a Java method to print all prime numbers from 1 to a given number.</li>
                <li>A prime number is only divisible by 1 and itself.</li>
                <li>Use a loop and a helper method to check if a number is prime.</li>
            </ol>
        </div>
