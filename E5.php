...
<body>
    ...
    <div class="exercise-container">
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Write a Java program to sort an array using Bubble Sort.</li>
                <li>Use nested loops to compare and swap adjacent values until the array is sorted.</li>
                <li>Print the sorted array after completion.</li>
            </ol>
        </div>
