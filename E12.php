...
<body>
    ...
    <div class="exercise-container">
        <h2>Permutations of a String : Prints all possible permutations of a given string (no repeated characters).</h2>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Write a Java recursive method to print all permutations of a given string.</li>
                <li>Use a loop to pick each character and generate all possible arrangements.</li>
                <!-- <li>Example input: <code>abc</code> → Output: <code>abc, acb, bac, bca, cab, cba</code></li> -->
            </ol>
        </div>
