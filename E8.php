...
<body>
    ...
    <div class="exercise-container">
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Write a Java method to check if a string is a palindrome.</li>
                <li>A palindrome reads the same forward and backward (e.g., <code>madam</code>).</li>
                <li>Compare characters from both ends ignoring case sensitivity.</li>
            </ol>
        </div>
