...
<body>
    ...
    <div class="exercise-container">
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Create a Java method to count the number of vowels in a given string.</li>
                <li>Check for characters <code>a, e, i, o, u</code> (case-insensitive).</li>
                <li>Print the total count of vowels found.</li>
            </ol>
        </div>
    ...
    public static void main(String[] args) {
        System.out.println("Vowel count: " + countVowels("Hello World")); // 3
    }
}`;
