...
<body>
    ...
    <div class="exercise-container">
        <h2>Calculation : Convert Decimal to Binary</h2>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Write a Java method to convert a decimal number to its binary equivalent.</li>
                <li>Use Java's built-in <code>Integer.toBinaryString()</code> method to convert the number.</li></li>
            </ol>
        </div>
