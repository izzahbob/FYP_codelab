...
<body>
    ...
    <div class="exercise-container">
        <h2>Simple Calculator: Swap Two Variables</h2>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Write a Java method that swaps two integer variables without using a third variable.</li>
                <li>Use arithmetic operations like addition and subtraction to swap values.</li>
                <li>Call the method with two integers, and print the values after swapping.</li>
            </ol>
        </div>
