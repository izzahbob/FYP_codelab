...
<body>
    ...
    <div class="exercise-container">
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Write a Java method to reverse a string without using built-in reverse functions.</li>
                <li>Use a character array and swap from both ends.</li>
                <li>Return and print the reversed version of the input string.</li>
            </ol>
        </div>
