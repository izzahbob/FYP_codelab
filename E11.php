...
<body>
    ...
    <div class="exercise-container">
        <h2>Count Frequency : Counts how many times each character appears in a string.</h2>
        ...
        <div class="instructions">
            ...
            <ol>
                <li>Write a Java method that counts how many times each character appears in a given string.</li>
                <li>Use an array to store ASCII character frequencies (size 256).</li>
                <li>Print each character along with its count.</li>
            </ol>
        </div>
